...
Figur \ref{fig:kavitasjonsterskel} viser verdiar for denne formelen for frekvensområdet \unit{20 - 200}{\kilo\hertz}.

\begin{figure}[htbp]
	\centering
	\label{fig:kavitasjonsterskel}
	\includegraphics[width=0.8\textwidth]{bilete/kavitasjonsterskel.pdf}
	\caption[Variasjon i kavitasjonsterskel som funksjon av frekvens]{Variasjon i kavitasjonsterskel som funksjon av frekvens for området \unit{20 - 200}{\kilo	\hertz}. Frekvensen er gitt i {\kilo\hertz} og kavitasjonsterskelen er gitt som det akustiske trykket i {\kilo\pascal} ei lydbølgje må ha for å oppnå kavitasjon.}
\end{	figure}
